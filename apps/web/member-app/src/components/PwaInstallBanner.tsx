...
const DISMISS_KEY = "osaja-pwa-install-dismissed";
        ...
        <div className="min-w-0 flex-1">
          ...
          {mode === "ios" ? (
            <p className="mt-1 text-sm text-slate-600">
              ...
              <strong>Add to Home Screen</strong> for quick access and notifications.
            </p>
          ) : mode === "native" ? (
            <p className="mt-1 text-sm text-slate-600">
              Add the member app to your home screen for faster access and offline support.
            </p>
          ) : (
            <p className="mt-1 text-sm text-slate-600">
